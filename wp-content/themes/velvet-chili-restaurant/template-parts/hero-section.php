...
$fallback_image = 'https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=1600&auto=format&fit=crop';

// Check if plugin is active and CPT exists
$has_plugin = defined( 'VCRC_ACTIVE' );
$has_cpt    = post_type_exists( 'vchs_hero_slide' );
