...
if ( defined( 'VCRC_ACTIVE' ) ) {
    ...
    if ( $query->have_posts() ) {
        ...
        $title    = get_the_title();
        $subtitle = get_post_meta( get_the_ID(), '_vcrc_chef_special_subtitle', true );
        $body     = get_post_meta( get_the_ID(), '_vcrc_chef_special_body', true );
...
<?php
    ...
    // Static fallback when plugin inactive
    ?>
<section class="menu-highlight" id="chefSpecial">
    <div class="menu-highlight__image">
