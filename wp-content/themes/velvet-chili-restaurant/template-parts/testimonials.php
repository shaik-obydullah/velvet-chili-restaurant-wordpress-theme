 ...
 * - Section title & background image from 'testimonial_area' CPT (single post)
 * - Carousel slides from 'testimonial' CPT
 * - Falls back to static HTML when no dynamic data available
 */

function vcrc_default_testimonials_html() {
    ?>
                        ...
                        <div class="testimonial-carousel__slides" id="testimonialSlides">
                            ...
                            <div class="testimonial-carousel__slide testimonial-carousel__slide--active">
                                <blockquote class="testimonial-carousel__quote">“The ancho ribeye was life‑changing.
                                    Perfect heat, incredible depth – I’ve never tasted anything like it. Velvet Chili is
                                    a gem.”</blockquote>
...
if ( ! defined( 'VCRC_ACTIVE' ) ) {
    vcrc_default_testimonials_html();
    return;
}
...
$area_title = $area_title ?: 'What Our Customers Say';
$area_image = $area_image ?: 'https://images.unsplash.com/photo-1559339352-11d035aa65de?q=80&w=1974&auto=format&fit=crop';

// 2. Get individual testimonials
